...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "qiskit.providers.aer.openpulse.cy.utils",
        "sources": [
            "qiskit/providers/aer/openpulse/cy/utils.pyx"
        ]
    },
    "module_name": "qiskit.providers.aer.openpulse.cy.utils"
}
END: Cython Metadata */
...
#define __PYX_HAVE__qiskit__providers__aer__openpulse__cy__utils
#define __PYX_HAVE_API__qiskit__providers__aer__openpulse__cy__utils
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'qiskit.providers.aer.openpulse.cy.utils' */
...
#define __Pyx_MODULE_NAME "qiskit.providers.aer.openpulse.cy.utils"
extern int __pyx_module_is_main_qiskit__providers__aer__openpulse__cy__utils;
int __pyx_module_is_main_qiskit__providers__aer__openpulse__cy__utils = 0;

/* Implementation of 'qiskit.providers.aer.openpulse.cy.utils' */
...
static const char __pyx_k_oplist_to_array[] = "oplist_to_array";
...
static const char __pyx_k_Input_list_does_not_fit_into_arr[] = "Input list does not fit into array if start_idx is {}.";
static const char __pyx_k_Invalid_mode_expected_c_or_fortr[] = "Invalid mode, expected 'c' or 'fortran', got %s";
static const char __pyx_k_Out_of_bounds_on_buffer_access_a[] = "Out of bounds on buffer access (axis %d)";
static const char __pyx_k_Unable_to_convert_item_to_object[] = "Unable to convert item to object";
static const char __pyx_k_got_differing_extents_in_dimensi[] = "got differing extents in dimension %d (got %d and %d)";
static const char __pyx_k_no_default___reduce___due_to_non[] = "no default __reduce__ due to non-trivial __cinit__";
static const char __pyx_k_qiskit_providers_aer_openpulse_c[] = "qiskit/providers/aer/openpulse/cy/utils.pyx";
static const char __pyx_k_unable_to_allocate_shape_and_str[] = "unable to allocate shape and strides.";
static const char __pyx_k_qiskit_providers_aer_openpulse_c_2[] = "qiskit.providers.aer.openpulse.cy.utils";
...
static PyObject *__pyx_kp_u_Input_list_does_not_fit_into_arr;
...
static PyObject *__pyx_n_s_oplist_to_array;
...
static PyObject *__pyx_pf_6qiskit_9providers_3aer_9openpulse_2cy_5utils_oplist_to_array(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_A, __Pyx_memviewslice __pyx_v_B, int __pyx_v_start_idx); /* proto */
...
/* "qiskit/providers/aer/openpulse/cy/utils.pyx":22
...
/* Python wrapper */
static PyObject *__pyx_pw_6qiskit_9providers_3aer_9openpulse_2cy_5utils_1oplist_to_array(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6qiskit_9providers_3aer_9openpulse_2cy_5utils_oplist_to_array[] = "Takes a list of complex numbers represented by a list\n    of pairs of floats, and inserts them into a complex NumPy\n    array at a given starting index.\n    \n    Parameters:\n        A (list): A nested-list of [re, im] pairs.\n        B(ndarray): Array for storing complex numbers from list A.\n        start_idx (int): The starting index at which to insert elements.\n        \n    Notes:\n        This is ~5x faster than doing it in Python.\n    ";
static PyMethodDef __pyx_mdef_6qiskit_9providers_3aer_9openpulse_2cy_5utils_1oplist_to_array = {"oplist_to_array", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6qiskit_9providers_3aer_9openpulse_2cy_5utils_1oplist_to_array, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6qiskit_9providers_3aer_9openpulse_2cy_5utils_oplist_to_array};
static PyObject *__pyx_pw_6qiskit_9providers_3aer_9openpulse_2cy_5utils_1oplist_to_array(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_A = 0;
  __Pyx_memviewslice __pyx_v_B = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_start_idx;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("oplist_to_array (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_A,&__pyx_n_s_B,&__pyx_n_s_start_idx,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_B)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("oplist_to_array", 0, 2, 3, 1); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
          PyObject* value = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_start_idx);
          if (value) { values[2] = value; kw_args--; }
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "oplist_to_array") < 0)) __PYX_ERR(0, 22, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_B = __Pyx_PyObject_to_MemoryviewSlice_dc___pyx_t_double_complex(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_B.memview)) __PYX_ERR(0, 22, __pyx_L3_error)
    if (values[2]) {
      __pyx_v_start_idx = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_start_idx == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L3_error)
    } else {
      __pyx_v_start_idx = ((int)0);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("oplist_to_array", 0, 2, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 22, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("qiskit.providers.aer.openpulse.cy.utils.oplist_to_array", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_A), (&PyList_Type), 1, "A", 1))) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_r = __pyx_pf_6qiskit_9providers_3aer_9openpulse_2cy_5utils_oplist_to_array(__pyx_self, __pyx_v_A, __pyx_v_B, __pyx_v_start_idx);
...
static PyObject *__pyx_pf_6qiskit_9providers_3aer_9openpulse_2cy_5utils_oplist_to_array(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_A, __Pyx_memviewslice __pyx_v_B, int __pyx_v_start_idx) {
  size_t __pyx_v_kk;
  unsigned int __pyx_v_lenA;
  ...
  size_t __pyx_t_11;
  __Pyx_RefNannySetupContext("oplist_to_array", 0);

  /* "qiskit/providers/aer/openpulse/cy/utils.pyx":37
 *     """
 *     cdef size_t kk
 ...
 */
  ...
  __pyx_t_1 = PyList_GET_SIZE(__pyx_v_A); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 37, __pyx_L1_error)
  __pyx_v_lenA = __pyx_t_1;

  /* "qiskit/providers/aer/openpulse/cy/utils.pyx":40
 *     cdef list temp
 * 
 ...
 * 
 */
  __pyx_t_2 = (((__pyx_v_start_idx + __pyx_v_lenA) > (__pyx_v_B.shape[0])) != 0);
  if (unlikely(__pyx_t_2)) {

    /* "qiskit/providers/aer/openpulse/cy/utils.pyx":41
 * 
 *     if (start_idx+lenA) > B.shape[0]:
 *         raise Exception('Input list does not fit into array if start_idx is {}.'.format(start_idx))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_kp_u_Input_list_does_not_fit_into_arr, __pyx_n_s_format); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_start_idx); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 41, __pyx_L1_error)
    ...
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(((PyObject *)(&((PyTypeObject*)PyExc_Exception)[0])), __pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
 ...
 */
  ...
  /* "qiskit/providers/aer/openpulse/cy/utils.pyx":43
 *         raise Exception('Input list does not fit into array if start_idx is {}.'.format(start_idx))
 * 
 *     for kk in range(lenA):             # <<<<<<<<<<<<<<
 *         temp = A[kk]
 ...
 */
  __pyx_t_7 = __pyx_v_lenA;
  __pyx_t_8 = __pyx_t_7;
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_kk = __pyx_t_9;

    /* "qiskit/providers/aer/openpulse/cy/utils.pyx":44
 * 
 *     for kk in range(lenA):
 *         temp = A[kk]             # <<<<<<<<<<<<<<
 *         B[start_idx+kk] = temp[0]+1j*temp[1]
 */
    ...
    if (!(likely(PyList_CheckExact(PyList_GET_ITEM(__pyx_v_A, __pyx_v_kk)))||((PyList_GET_ITEM(__pyx_v_A, __pyx_v_kk)) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(PyList_GET_ITEM(__pyx_v_A, __pyx_v_kk))->tp_name), 0))) __PYX_ERR(0, 44, __pyx_L1_error)
    __pyx_t_4 = PyList_GET_ITEM(__pyx_v_A, __pyx_v_kk);
    __Pyx_INCREF(__pyx_t_4);
    __Pyx_XDECREF_SET(__pyx_v_temp, ((PyObject*)__pyx_t_4));
    __pyx_t_4 = 0;

    /* "qiskit/providers/aer/openpulse/cy/utils.pyx":45
 *     for kk in range(lenA):
 *         temp = A[kk]
 *         B[start_idx+kk] = temp[0]+1j*temp[1]             # <<<<<<<<<<<<<<
 */
    ...
    __pyx_t_4 = PyComplex_FromDoubles(0.0, 1.0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    if (unlikely(__pyx_v_temp == Py_None)) {
      PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
      __PYX_ERR(0, 45, __pyx_L1_error)
    }
    __pyx_t_3 = PyNumber_Multiply(__pyx_t_4, PyList_GET_ITEM(__pyx_v_temp, 1)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyNumber_Add(PyList_GET_ITEM(__pyx_v_temp, 0), __pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_10 = __Pyx_PyComplex_As___pyx_t_double_complex(__pyx_t_4); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_11 = (__pyx_v_start_idx + __pyx_v_kk);
    *((__pyx_t_double_complex *) ( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_B.data) + __pyx_t_11)) )) = __pyx_t_10;
  }
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "qiskit.providers.aer.openpulse.cy.utils.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "qiskit.providers.aer.openpulse.cy.utils.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "qiskit.providers.aer.openpulse.cy.utils.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "qiskit.providers.aer.openpulse.cy.utils._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_Input_list_does_not_fit_into_arr, __pyx_k_Input_list_does_not_fit_into_arr, sizeof(__pyx_k_Input_list_does_not_fit_into_arr), 0, 1, 0, 0},
  ...
  {&__pyx_n_s_oplist_to_array, __pyx_k_oplist_to_array, sizeof(__pyx_k_oplist_to_array), 0, 0, 1, 1},
 ...
 *     """Takes a list of complex numbers represented by a list
 */
  __pyx_tuple__19 = PyTuple_Pack(6, __pyx_n_s_A, __pyx_n_s_B, __pyx_n_s_start_idx, __pyx_n_s_kk, __pyx_n_s_lenA, __pyx_n_s_temp); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(3, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_qiskit_providers_aer_openpulse_c, __pyx_n_s_oplist_to_array, 22, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 22, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_qiskit__providers__aer__openpulse__cy__utils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "qiskit.providers.aer.openpulse.cy.utils")) {
      if (unlikely(PyDict_SetItemString(modules, "qiskit.providers.aer.openpulse.cy.utils", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     """Takes a list of complex numbers represented by a list
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6qiskit_9providers_3aer_9openpulse_2cy_5utils_1oplist_to_array, NULL, __pyx_n_s_qiskit_providers_aer_openpulse_c_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_oplist_to_array, __pyx_t_1) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "qiskit/providers/aer/openpulse/cy/utils.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * #!python
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init qiskit.providers.aer.openpulse.cy.utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init qiskit.providers.aer.openpulse.cy.utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
