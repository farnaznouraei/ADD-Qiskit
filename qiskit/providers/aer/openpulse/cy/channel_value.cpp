...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "qiskit.providers.aer.openpulse.cy.channel_value",
        "sources": [
            "qiskit/providers/aer/openpulse/cy/channel_value.pyx"
        ]
    },
    "module_name": "qiskit.providers.aer.openpulse.cy.channel_value"
}
END: Cython Metadata */
...
#define __PYX_HAVE__qiskit__providers__aer__openpulse__cy__channel_value
#define __PYX_HAVE_API__qiskit__providers__aer__openpulse__cy__channel_value
/* Early includes */
#include <math.h>
#include <complex>
#include "pythread.h"
...
/* Module declarations from 'qiskit.providers.aer.openpulse.cy.channel_value' */
...
static CYTHON_INLINE int __pyx_f_6qiskit_9providers_3aer_9openpulse_2cy_13channel_value_get_arr_idx(double, double, double, int); /*proto*/
...
#define __Pyx_MODULE_NAME "qiskit.providers.aer.openpulse.cy.channel_value"
extern int __pyx_module_is_main_qiskit__providers__aer__openpulse__cy__channel_value;
int __pyx_module_is_main_qiskit__providers__aer__openpulse__cy__channel_value = 0;

/* Implementation of 'qiskit.providers.aer.openpulse.cy.channel_value' */
...
/* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":28
 * 
...
static CYTHON_INLINE int __pyx_f_6qiskit_9providers_3aer_9openpulse_2cy_13channel_value_get_arr_idx(double __pyx_v_t, double __pyx_v_start, double __pyx_v_stop, int __pyx_v_len_arr) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_arr_idx", 0);

  /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":40
 ...
 */
  __pyx_r = ((int)floor((((__pyx_v_t - __pyx_v_start) / (__pyx_v_stop - __pyx_v_start)) * __pyx_v_len_arr)));
  goto __pyx_L0;
...
/* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":43
 * 
 * @cython.boundscheck(False)
...
static __pyx_t_double_complex __pyx_f_6qiskit_9providers_3aer_9openpulse_2cy_13channel_value_chan_value(double __pyx_v_t, CYTHON_UNUSED unsigned int __pyx_v_chan_num, double __pyx_v_freq_ch, __Pyx_memviewslice __pyx_v_chan_pulse_times, __Pyx_memviewslice __pyx_v_pulse_array, __Pyx_memviewslice __pyx_v_pulse_ints, __Pyx_memviewslice __pyx_v_fc_array, __Pyx_memviewslice __pyx_v_register) {
  size_t __pyx_v_kk;
  double __pyx_v_start_time;
  double __pyx_v_stop_time;
  double __pyx_v_phase;
  int __pyx_v_start_idx;
  int __pyx_v_stop_idx;
  int __pyx_v_offset_idx;
  int __pyx_v_temp_int;
  int __pyx_v_cond;
  __pyx_t_double_complex __pyx_v_out;
  unsigned int __pyx_v_num_times;
  long __pyx_v_do_fc;
  ...
  size_t __pyx_t_18;
  __Pyx_RefNannySetupContext("chan_value", 0);

  /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":68
 *     """
 *     cdef size_t kk
 ...
 */
  ...
  /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":70
 *     cdef double start_time, stop_time, phase=0
 *     cdef int start_idx, stop_idx, offset_idx, temp_int, cond
 *     cdef complex out = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":73
 *     # This is because each entry has four values:
 *     # start_time, stop_time, pulse_int, conditional
 ...
 */
  __pyx_v_num_times = __Pyx_div_Py_ssize_t((__pyx_v_chan_pulse_times.shape[0]), 4);

  /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":75
 *     cdef unsigned int num_times = chan_pulse_times.shape[0] // 4
 * 
 *     for kk in range(num_times):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":77
 *     for kk in range(num_times):
 *         # the time is overlapped with the kkth pulse
 *         start_time = chan_pulse_times[4*kk]             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_4 = (4 * __pyx_v_kk);
    __pyx_v_start_time = (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_chan_pulse_times.data) + __pyx_t_4)) )));

    /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":78
 *         # the time is overlapped with the kkth pulse
 *         start_time = chan_pulse_times[4*kk]
 *         stop_time = chan_pulse_times[4*kk+1]             # <<<<<<<<<<<<<<
 *         if start_time <= t < stop_time:
 ...
 */
    __pyx_t_5 = ((4 * __pyx_v_kk) + 1);
    __pyx_v_stop_time = (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_chan_pulse_times.data) + __pyx_t_5)) )));

    /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":79
 *         start_time = chan_pulse_times[4*kk]
 *         stop_time = chan_pulse_times[4*kk+1]
 *         if start_time <= t < stop_time:             # <<<<<<<<<<<<<<
 *             cond = <int>chan_pulse_times[4*kk+3]
 ...
 */
    __pyx_t_6 = (__pyx_v_start_time <= __pyx_v_t);
    if (__pyx_t_6) {
      __pyx_t_6 = (__pyx_v_t < __pyx_v_stop_time);
    }
    __pyx_t_7 = (__pyx_t_6 != 0);
    if (__pyx_t_7) {

      /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":80
 *         stop_time = chan_pulse_times[4*kk+1]
 *         if start_time <= t < stop_time:
 *             cond = <int>chan_pulse_times[4*kk+3]             # <<<<<<<<<<<<<<
 *             if cond < 0 or register[cond]:
 ...
 */
      __pyx_t_8 = ((4 * __pyx_v_kk) + 3);
      __pyx_v_cond = ((int)(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_chan_pulse_times.data) + __pyx_t_8)) ))));

      /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":81
 *         if start_time <= t < stop_time:
 *             cond = <int>chan_pulse_times[4*kk+3]
 *             if cond < 0 or register[cond]:             # <<<<<<<<<<<<<<
 *                 temp_int = <int>chan_pulse_times[4*kk+2]
 ...
 */
      __pyx_t_6 = ((__pyx_v_cond < 0) != 0);
      if (!__pyx_t_6) {
      } else {
        __pyx_t_7 = __pyx_t_6;
        goto __pyx_L7_bool_binop_done;
      }
      __pyx_t_9 = __pyx_v_cond;
      if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_register.shape[0];
      __pyx_t_6 = ((*((unsigned char *) ( /* dim=0 */ ((char *) (((unsigned char *) __pyx_v_register.data) + __pyx_t_9)) ))) != 0);
      __pyx_t_7 = __pyx_t_6;
      __pyx_L7_bool_binop_done:;
      if (__pyx_t_7) {

        /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":82
 *             cond = <int>chan_pulse_times[4*kk+3]
 *             if cond < 0 or register[cond]:
 *                 temp_int = <int>chan_pulse_times[4*kk+2]             # <<<<<<<<<<<<<<
 *                 start_idx = pulse_ints[temp_int]
 ...
 */
        __pyx_t_10 = ((4 * __pyx_v_kk) + 2);
        __pyx_v_temp_int = ((int)(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_chan_pulse_times.data) + __pyx_t_10)) ))));

        /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":83
 *             if cond < 0 or register[cond]:
 *                 temp_int = <int>chan_pulse_times[4*kk+2]
 *                 start_idx = pulse_ints[temp_int]             # <<<<<<<<<<<<<<
 *                 stop_idx = pulse_ints[temp_int+1]
 ...
 */
        __pyx_t_11 = __pyx_v_temp_int;
        if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_pulse_ints.shape[0];
        __pyx_v_start_idx = (*((unsigned int *) ( /* dim=0 */ ((char *) (((unsigned int *) __pyx_v_pulse_ints.data) + __pyx_t_11)) )));

        /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":84
 *                 temp_int = <int>chan_pulse_times[4*kk+2]
 *                 start_idx = pulse_ints[temp_int]
 *                 stop_idx = pulse_ints[temp_int+1]             # <<<<<<<<<<<<<<
 *                 offset_idx = get_arr_idx(t, start_time, stop_time, stop_idx-start_idx)
 ...
 */
        __pyx_t_12 = (__pyx_v_temp_int + 1);
        if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_pulse_ints.shape[0];
        __pyx_v_stop_idx = (*((unsigned int *) ( /* dim=0 */ ((char *) (((unsigned int *) __pyx_v_pulse_ints.data) + __pyx_t_12)) )));

        /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":85
 *                 start_idx = pulse_ints[temp_int]
 *                 stop_idx = pulse_ints[temp_int+1]
 *                 offset_idx = get_arr_idx(t, start_time, stop_time, stop_idx-start_idx)             # <<<<<<<<<<<<<<
 *                 out = pulse_array[start_idx+offset_idx]
 *             break
 */
        __pyx_v_offset_idx = __pyx_f_6qiskit_9providers_3aer_9openpulse_2cy_13channel_value_get_arr_idx(__pyx_v_t, __pyx_v_start_time, __pyx_v_stop_time, (__pyx_v_stop_idx - __pyx_v_start_idx));

        /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":86
 *                 stop_idx = pulse_ints[temp_int+1]
 *                 offset_idx = get_arr_idx(t, start_time, stop_time, stop_idx-start_idx)
 *                 out = pulse_array[start_idx+offset_idx]             # <<<<<<<<<<<<<<
 *             break
 ...
 */
        __pyx_t_13 = (__pyx_v_start_idx + __pyx_v_offset_idx);
        if (__pyx_t_13 < 0) __pyx_t_13 += __pyx_v_pulse_array.shape[0];
        __pyx_v_out = (*((__pyx_t_double_complex *) ( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_pulse_array.data) + __pyx_t_13)) )));
 ...
 */
      ...
      /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":87
 *                 offset_idx = get_arr_idx(t, start_time, stop_time, stop_idx-start_idx)
 *                 out = pulse_array[start_idx+offset_idx]
 *             break             # <<<<<<<<<<<<<<
 *     # Compute the frame change up to time t
 ...
 */
  ...
  /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":89
 *             break
 *     # Compute the frame change up to time t
 *     if out != 0:             # <<<<<<<<<<<<<<
 ...
 *         for kk in range(num_times):
 */
  __pyx_t_7 = ((!__Pyx_c_eq_double(__pyx_v_out, __pyx_t_double_complex_from_parts(0, 0))) != 0);
  if (__pyx_t_7) {

    /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":90
 *     # Compute the frame change up to time t
 *     if out != 0:
 *         num_times = fc_array.shape[0] // 3             # <<<<<<<<<<<<<<
 *         for kk in range(num_times):
 *             if t >= fc_array[3*kk]:
 */
    __pyx_v_num_times = __Pyx_div_Py_ssize_t((__pyx_v_fc_array.shape[0]), 3);

    /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":91
 *     if out != 0:
 *         num_times = fc_array.shape[0] // 3
 *         for kk in range(num_times):             # <<<<<<<<<<<<<<
 *             if t >= fc_array[3*kk]:
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":92
 *         num_times = fc_array.shape[0] // 3
 *         for kk in range(num_times):
 *             if t >= fc_array[3*kk]:             # <<<<<<<<<<<<<<
 *                 do_fc = 1
 ...
 */
      __pyx_t_14 = (3 * __pyx_v_kk);
      __pyx_t_7 = ((__pyx_v_t >= (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_fc_array.data) + __pyx_t_14)) )))) != 0);
      if (__pyx_t_7) {

        /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":93
 *         for kk in range(num_times):
 *             if t >= fc_array[3*kk]:
 *                 do_fc = 1             # <<<<<<<<<<<<<<
 *                 # Check if FC is conditioned on register
 ...
 */
        ...
        /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":95
 *                 do_fc = 1
 *                 # Check if FC is conditioned on register
 *                 if fc_array[3*kk+2] >= 0:             # <<<<<<<<<<<<<<
 ...
 */
        __pyx_t_15 = ((3 * __pyx_v_kk) + 2);
        __pyx_t_7 = (((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_fc_array.data) + __pyx_t_15)) ))) >= 0.0) != 0);
        if (__pyx_t_7) {

          /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":97
 *                 if fc_array[3*kk+2] >= 0:
 *                     # If condition not satisfied no do FC
 *                     if not register[<int>fc_array[3*kk+2]]:             # <<<<<<<<<<<<<<
 *                         do_fc = 0
 *                 if do_fc:
 */
          __pyx_t_16 = ((3 * __pyx_v_kk) + 2);
          __pyx_t_17 = ((int)(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_fc_array.data) + __pyx_t_16)) ))));
          if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_register.shape[0];
          __pyx_t_7 = ((!((*((unsigned char *) ( /* dim=0 */ ((char *) (((unsigned char *) __pyx_v_register.data) + __pyx_t_17)) ))) != 0)) != 0);
          if (__pyx_t_7) {

            /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":98
 *                     # If condition not satisfied no do FC
 *                     if not register[<int>fc_array[3*kk+2]]:
 *                         do_fc = 0             # <<<<<<<<<<<<<<
 *                 if do_fc:
 ...
 */
        ...
        /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":99
 *                     if not register[<int>fc_array[3*kk+2]]:
 *                         do_fc = 0
 *                 if do_fc:             # <<<<<<<<<<<<<<
 *                     # Update the frame change value
 ...
 */
        __pyx_t_7 = (__pyx_v_do_fc != 0);
        if (__pyx_t_7) {

          /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":101
 *                 if do_fc:
 *                     # Update the frame change value
 *                     phase += fc_array[3*kk+1]             # <<<<<<<<<<<<<<
 *             else:
 *                 break
 */
          __pyx_t_18 = ((3 * __pyx_v_kk) + 1);
          __pyx_v_phase = (__pyx_v_phase + (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_fc_array.data) + __pyx_t_18)) ))));
 ...
 */
      ...
      /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":103
 *                     phase += fc_array[3*kk+1]
 *             else:
 *                 break             # <<<<<<<<<<<<<<
 *         if phase != 0:
 ...
 */
    ...
    /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":104
 *             else:
 *                 break
 *         if phase != 0:             # <<<<<<<<<<<<<<
 *             out *= exp(1j*phase)
 ...
 */
    __pyx_t_7 = ((__pyx_v_phase != 0.0) != 0);
    if (__pyx_t_7) {

      /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":105
 *                 break
 *         if phase != 0:
 *             out *= exp(1j*phase)             # <<<<<<<<<<<<<<
 *         out *= exp(-1j*2*M_PI*freq_ch*t)
 *     return out
 */
      __pyx_v_out = __Pyx_c_prod_double(__pyx_v_out, std::exp(__Pyx_c_prod_double(__pyx_t_double_complex_from_parts(0, 1.0), __pyx_t_double_complex_from_parts(__pyx_v_phase, 0))));
 ...
 */
    ...
    /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":106
 *         if phase != 0:
 *             out *= exp(1j*phase)
 *         out *= exp(-1j*2*M_PI*freq_ch*t)             # <<<<<<<<<<<<<<
 *     return out
 */
    __pyx_v_out = __Pyx_c_prod_double(__pyx_v_out, std::exp(__Pyx_c_prod_double(__Pyx_c_prod_double(__Pyx_c_prod_double(__Pyx_c_prod_double(__Pyx_c_neg_double(__pyx_t_double_complex_from_parts(0, 1.0)), __pyx_t_double_complex_from_parts(2, 0)), __pyx_t_double_complex_from_parts(M_PI, 0)), __pyx_t_double_complex_from_parts(__pyx_v_freq_ch, 0)), __pyx_t_double_complex_from_parts(__pyx_v_t, 0))));
 ...
 */
  ...
  /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":107
 *             out *= exp(1j*phase)
 *         out *= exp(-1j*2*M_PI*freq_ch*t)
 *     return out             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "qiskit.providers.aer.openpulse.cy.channel_value.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "qiskit.providers.aer.openpulse.cy.channel_value.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "qiskit.providers.aer.openpulse.cy.channel_value.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "qiskit.providers.aer.openpulse.cy.channel_value._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_channel_value(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_channel_value},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("chan_value", (void (*)(void))__pyx_f_6qiskit_9providers_3aer_9openpulse_2cy_13channel_value_chan_value, "__pyx_t_double_complex (double, unsigned int, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initchannel_value(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initchannel_value(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_channel_value(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_channel_value(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_channel_value(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'channel_value' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_channel_value(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("channel_value", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_qiskit__providers__aer__openpulse__cy__channel_value) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "qiskit.providers.aer.openpulse.cy.channel_value")) {
      if (unlikely(PyDict_SetItemString(modules, "qiskit.providers.aer.openpulse.cy.channel_value", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "qiskit/providers/aer/openpulse/cy/channel_value.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * #!python
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init qiskit.providers.aer.openpulse.cy.channel_value", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init qiskit.providers.aer.openpulse.cy.channel_value");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
